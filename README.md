...
- [X] **Dzień 2**. **Uruchomisz Colab**, zainstalujesz potrzebne biblioteki oraz skonfigurujesz współpracę pomiędzy GitHub a Colab i zobaczysz jak fajnie to działa.
- [X] **Dzień 3**. Poznasz miejsce, gdzie są **dziesiątki milionów publicznie dostępnych danych**, nauczysz się z tego korzystać i zaczniesz budować swoje portfolio.
